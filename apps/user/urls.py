...
from.views import LoginAPIView,LoginRefreshAPIView,LogOutAPIView,CreateUserAPIView,VerifyUserAPIView,GetNewVerificationAPIView,\
    ChangeUserInfoAPIView,ChangeUserPhotoAPIView,FrgotPasswordAPIView,ResetPasswordAPIView
